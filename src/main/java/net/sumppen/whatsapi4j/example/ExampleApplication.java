...
/**
 * Example application Launch with: java -cp target/dependency/*:target/whatsapi4j-1.0.0-SNAPSHOT.jar net.sumppen.whatsapi4j.example.ExampleApplication 5527988715981 'DJja866Q14yhFL6rKWQQg3bB+Fs=' 'mytestapplication' 'My Test Account'
 *
 * @author kim
 *
 */
